...
Viewport 854×694 · 2026-08-15T13:42:57.451Z
...
| who-are-ya | PASS | FAIL (12 vs 28) | PASS | yes | yes | 20px | 560px | normal | 3 |
| tictactoe | PASS | PASS | PASS | yes | yes | 20px | 560px | normal | 3 |
| bingo | PASS | PASS | PASS | yes | yes | 20px | 560px | normal | 4 |
| contexto | PASS | FAIL (12 vs 28) | PASS | yes | yes | 20px | 560px | normal | 3 |
| who-would-win | PASS | PASS | PASS | yes | yes | 20px | 560px | normal | 5 |
...
### series-winner
- root: `gf` — width 499.6px, gap `20px`, align `normal`
- shell: top 22.2 · game→exit 28 · exit→bottom 22.2
...
### who-are-ya
- root: `gf gf--fill` — width 499.6px, gap `20px`, align `normal`
- shell: top 22.2 · game→exit 12 · exit→bottom 22.2
- first child offset: 0 · gaps between children: [20,20]

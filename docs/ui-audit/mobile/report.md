...
Viewport 390×844 · 2026-08-15T21:22:04.648Z
...
| starting-five | PASS | PASS | PASS | NO | yes | 20px | 720px | normal | 2 |
...
### series-winner
- root: `gf` — width 319px, gap `20px`, align `normal`
- shell: top 14 · game→exit 28 · exit→bottom 14
...
### superdraft
- root: `gf gf--fill` — width 319px, gap `20px`, align `normal`
- shell: top 14 · game→exit 12 · exit→bottom 14
- first child offset: 0 · gaps between children: [20,20,20,20]
